...
//
//@Config
//@Autonomous(name = "TestTrajectoryTimeline", preselectTeleOp = "Duo")
//public class TestTrajectoryTimeline extends LinearOpMode {
//    //region 初始化
...
//                robot.subsystem.slamDunker.onAir();//放下机械臂
//            }), // 初始位置
//            new Trajectory(2, -39, 0, 0, 0), //平移到潜水器
//            new Trajectory(4, -39, 0, 0, 0,() -> {
//                sleep(2000);
//                robot.subsystem.slamDunker.onChamber();
//            }), //等待
//            new Trajectory(4, -39, 0, 150, 80,() -> {}), //挂上预载标本
//            new Trajectory(9, -48, 44, 100, 0,() -> {}), //走到推样本的位置 即样本后方
//            new Trajectory(12, -5, 44, 0, 0,() -> {
//                sleep(700);
//                robot.subsystem.slamDunker.onGround(DcMotor.ZeroPowerBehavior.BRAKE).release();
//            }),//推第一个
//            new Trajectory(13, -30, 44, 0, 0,() -> {}),//向后走一点
//            new Trajectory(16, -30, 44, 0, 0,() -> {}),//等待标本制作完成
//            new Trajectory(17, -10, 44, 0, 0,() -> {
//                sleep(100);
//                robot.subsystem.slamDunker.grab();//抓住人类玩家做好的样本
//            }),//向前走 准备夹标本
//            new Trajectory(18, -10, 44, 0, 0,() -> {}),//等待夹住样本
//            new Trajectory(18, -10, 44, 50, 0,() -> {}),//夹住标本
//            new Trajectory(22, -40, -8, 0, 0,() -> {
//                sleep(300);
...
//            }),//移动至潜水器挂样本
//            new Trajectory(23, -40, -8, 0, 0,() -> {}),//等待挂好样本
//            new Trajectory(27, 0, 48, 0, 0,() -> {})// 回到角落
//    };
...
//            final int index = i;
//            new Thread(() -> {
//                sleep((long) (trajectory[index].t*1000));

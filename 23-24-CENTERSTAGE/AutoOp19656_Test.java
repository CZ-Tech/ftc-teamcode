...
@Autonomous(name = "自动操控模式_Test", group = "Robot", preselectTeleOp = "手动阶段")
//@Disabled
        ...
        switch (MISSION) {
            case 1 :
                robot
                    ...
                    .setLeftIntakePower(0)
                        //边转边走
                    .driveStraight(-1.0, 90, 0.5)
                    .G(0.0)
                    .G(90)
                    .driveStrafe(36.0, 90, 0.5);
            ...
            case 2 :
                robot
                    .driveStrafe(26.0, 0, 0.5)//TODO:待调试
                        //启动飞轮放像素
                    .setLeftIntakePower(-1.0)
                    .sleep(500)
                    .setLeftIntakePower(0)
